...
function KanbanCard({
  ...
  const canEdit = !todo.sharing || todo.sharing.role === "editor";

  return (
    <div
      className={`group/item rounded-xl border bg-card p-3.5 transition-all hover:shadow-md ${canEdit ? "cursor-grab active:cursor-grabbing" : ""}`}
      draggable={canEdit}
